    ...
    function verify(token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _g = productionVerifier;
                        if (!_g) return [3 /*break*/, 2];
                        return [4 /*yield*/, productionVerifier.verify(token)];
                    case 1:
                        _g = (_h.sent());
                        _h.label = 2;
                    case 2: return [2 /*return*/, _g || developmentVerifier && developmentVerifier.verify(token)];
                }
            });
        });
    }
        ...
        function verify(token) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0: return [4 /*yield*/, verify_1.verify(token)];
                        case 1:
                            result = _g.sent();
                            return [2 /*return*/, is(result) ? result : undefined];
                    }
                });
            });
        }
...
var flawedContent_1 = createCommonjsModule(function (module, exports) {
    ...
    function flawedContent(content) {
        return { status: 400, type: "flawed content", content: content };
    }
...
var invalidContent_1 = createCommonjsModule(function (module, exports) {
    ...
    function invalidContent(type, description, details) {
        return { status: 400, type: "invalid content", content: { type: type, description: description, details: details } };
    }
...
var invalidPathArgument_1 = createCommonjsModule(function (module, exports) {
    ...
    function invalidPathArgument(pattern, name, type, description) {
        return { status: 400, type: "invalid path argument", pattern: pattern, argument: { name: name, type: type, description: description } };
    }
...
var invalidQueryArgument_1 = createCommonjsModule(function (module, exports) {
    ...
    function invalidQueryArgument(name, type, description) {
        return { status: 400, type: "invalid query argument", argument: { name: name, type: type, description: description } };
    }
...
var malformedContent_1 = createCommonjsModule(function (module, exports) {
    ...
    function malformedContent(property, type, description, details) {
        return { status: 400, type: "malformed content", content: { property: property, type: type, description: description } };
    }
...
var methodNotAllowed_1 = createCommonjsModule(function (module, exports) {
    ...
    var methods = ["GET", "POST", "DELETE", "HEAD", "PATCH", "PUT", "OPTIONS", "TRACE", "CONNECT"];
    function methodNotAllowed() {
        var allow = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            allow[_i] = arguments[_i];
        }
        return { status: 405, type: "method not allowed", header: { allow: allow } };
    }
    ...
    (function (methodNotAllowed) {
        function is(value) {
            return typeof value == "object" &&
                ...
                value.header.allow.every(function (m) { return methods.some(m); }) &&
...
var missingProperty_1 = createCommonjsModule(function (module, exports) {
    ...
    function missingProperty(property, type, description) {
        return { status: 400, type: "missing property", content: typeof description == "string" ? { property: property, type: type, description: description } : Object.assign({ property: property, type: type }, description) };
    }
...
var missingQueryArgument_1 = createCommonjsModule(function (module, exports) {
    ...
    function missingQueryArgument(name, type, description) {
        return { status: 400, type: "missing query argument", argument: { name: name, type: type, description: description } };
    }
...
var backendFailure_1 = createCommonjsModule(function (module, exports) {
    ...
    function backendFailure(backend, details, reference) {
        ...
        return { status: 502, type: "backend failure", backend: backend, details: details, reference: reference };
    }
...
var databaseFailure_1 = createCommonjsModule(function (module, exports) {
    ...
    function databaseFailure(details) {
        return { status: 502, type: "database failure", details: details };
    }
...
var missconfigured_1 = createCommonjsModule(function (module, exports) {
    ...
    function missconfigured(key, description) {
        return { status: 503, type: "missing configuration", key: key, description: description };
    }
...
var unknown_1 = createCommonjsModule(function (module, exports) {
    ...
    function unknown(error) {
        return { status: 500, type: "unknown error", error: error };
    }
    ...
    (function (Pan) {
        function is(value) {
            return typeof (value) == "string" &&
                ...
                Array.from(value).every(function (c) { return c >= "0" && c <= "9"; });
        }
        Pan.is = is;
        function scheme(pan) {
            var result = "unknown";
    ...
    (function (Creatable) {
        function is(value) {
            return (value.amount == undefined || typeof value.amount == "number") &&
                (value.descriptor == undefined || typeof value.descriptor == "string") &&
                Object.keys(value).every(function (key) { return key == "amount" || key == "descriptor"; });
        }
        Creatable.is = is;
    })(Creatable = exports.Creatable || (exports.Creatable = {}));
});
    ...
    (function (KeyInfo) {
        ...
        function flaw(value) {
            ...
            return {
                ...
                flaws: typeof value != "object" ? undefined :
                    __spreadArrays(((_a = KeyInfo_1.KeyInfo.flaw(value).flaws) !== null && _a !== void 0 ? _a : []), ((_b = Override_1.Override.flaw(value).flaws) !== null && _b !== void 0 ? _b : [])).filter(dist.Flaw.is),
            };
        }
        KeyInfo.flaw = flaw;
    })(KeyInfo = exports.KeyInfo || (exports.KeyInfo = {}));
    ...
    (function (Configuration) {
        ...
        function flaw(value) {
            ...
            return {
                ...
                flaws: typeof value != "object" ? undefined :
                    __spreadArrays(((_a = Card_1$1.Card.flaw(value).flaws) !== null && _a !== void 0 ? _a : []), ((_b = Override_1.Override.flaw(value).flaws) !== null && _b !== void 0 ? _b : [])).filter(dist.Flaw.is),
            };
        }
        ...
        function flaw(value) {
            ...
            return {
                ...
                flaws: typeof value != "object" ? undefined :
                    ...
                    ], ((_a = KeyInfo_2.KeyInfo.flaw(value.card).flaws) !== null && _a !== void 0 ? _a : [{ property: "card", type: "model.Merchant.Configuration.KeyInfo", flaws: undefined }])).filter(dist.Flaw.is),
            };
        }
        KeyInfo.flaw = flaw;
                ...
                return __generator(this, function (_g) {
                    switch (_g.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, dist$2.Verifier.create(audience).verify(key)];
                        case 1:
                            result = _g.sent();
                            if (!(result && ((_a = result.option) === null || _a === void 0 ? void 0 : _a.card))) return [3 /*break*/, 3];
                            return [4 /*yield*/, dist$2.Verifier.create(audience).verify(result.option.card)];
                        case 2:
                            cardKey = _g.sent();
            ...
            return {
                ...
                flaws: typeof value != "object" ? undefined :
                    __spreadArrays([
                        ...
                        typeof value.url == "string" || { property: "url", type: "string" },
                        value.mixed == undefined || typeof value.mixed == "string" || { property: "mixed", type: "authly.Token", condition: "Alternate key." }
                    ], ((_a = Configuration_1.Configuration.flaw(value.card).flaws) !== null && _a !== void 0 ? _a : [{ property: "card", type: "model.Merchant.Configuration", flaws: undefined }])).filter(dist.Flaw.is),
            };
        }
        Key.flaw = flaw;
        function upgrade(key) {
            ...
            return {
                ...
                flaws: typeof (value) != "object" ? undefined :
                    __spreadArrays([
                        ...
                        typeof value.name == "string" || { property: "name", type: "string" },
                        typeof value.url == "string" || { property: "url", type: "string" }
                    ], (KeyInfo_1.KeyInfo.flaw(value).flaws || [])).filter(dist.Flaw.is),
            };
        }
        KeyInfo.flaw = flaw;
    })(KeyInfo = exports.KeyInfo || (exports.KeyInfo = {}));
            ...
            return {
                ...
                flaws: typeof (value) != "object" ? undefined :
                    __spreadArrays([
                        ...
                        typeof value.name == "string" || { property: "name", type: "string" },
                        typeof value.url == "string" || { property: "url", type: "string" }
                    ], (Card_1$1.Card.flaw(value).flaws || [])).filter(dist.Flaw.is),
            };
        }
        Key.flaw = flaw;
        var KeyInfo;
...
var MerchantKeyInfoUnpack = dist_3.Key.KeyInfo.unpack;
var styleCss = ":host{display:block;height:calc(5em - 3px);overflow:hidden;width:100%}:host[hidden]{display:none}:host>smoothly-dialog>header>smoothly-trigger{z-index:1}";
var Form = /** @class */ (function () {
    ...
    Form.prototype.componentWillLoad = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _g, styleLink, themeLink;
            return __generator(this, function (_h) {
                switch (_h.label) {
                    case 0:
                        _g = this;
                        return [4 /*yield*/, MerchantKeyInfoUnpack(this.apiKey, "public")];
                    case 1:
                        _g.merchant = _h.sent();
                        styleLink = document.querySelector("link[rel=stylesheet][href^='https://theme.payfunc.com/']");
                        if (styleLink) {
                            themeLink = styleLink.href.substring(26);
    ...
    Form.prototype.handleTrigger = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b;
            return __generator(this, function (_g) {
    ...
    Form.prototype.submit = function (authorization) {
        var _this = this;
        this.authorization = authorization;
        return new Promise(function (callback) {
            if (_this.frame) {
                _this.received = function (_, response) { return callback(response); };
                _this.frame.send("card", { name: "submitVersion1", value: { authorization: authorization, key: _this.apiKey, parent: window.location.origin } });
                _this.state = "processing";
            }
        });
    };
    Form.prototype.do3d = function (authorization, error) {
        var _this = this;
        this.authorization = authorization;
        return new Promise(function (callback) {
            if (_this.frame) {
                _this.received3d = function (_, response) { return callback(response); };
                var value = { authorization: authorization, key: _this.apiKey, parent: window.location.origin };
                if (error)
                    value = Object.assign(Object.assign({}, value), { error: error });
                _this.frame.send("card", { name: "do3d", value: value });
                _this.state3d = "processing";
            }
        });
    };
    Form.prototype.render = function () {
        ...
        return [
            this.merchant ? h("smoothly-frame", { url: this.merchant.card.url + "/ui/web-app/" + (this.theme ? "?theme=" + this.theme : ""), name: "card", ref: function (element) { return _this.frame = element; } }) : [],
            this.verify ?
...
var SmoothlyDialog = /** @class */ (function () {
    ...
    SmoothlyDialog.prototype.__stencil_render = function () {
        return [
    ...
    SmoothlyDialog.prototype.render = function () { return h(Host, this.hostData(), this.__stencil_render()); };
    return SmoothlyDialog;
}());
SmoothlyDialog.style = styleCss$1;
var styleCss$2 = ".sc-smoothly-frame-h{display:block;width:100%;height:100%}[hidden].sc-smoothly-frame-h{display:none}.sc-smoothly-frame-h>iframe.sc-smoothly-frame{border:none;padding:none;margin:none}";
var SmoothlyFrame = /** @class */ (function () {
    function SmoothlyFrame(hostRef) {
        registerInstance(this, hostRef);
        this.trigger = createEvent(this, "trigger", 7);
        this.message = createEvent(this, "message", 7);
    }
    Object.defineProperty(SmoothlyFrame.prototype, "contentWindow", {
        get: function () {
            var iframe = this.element && this.element.firstElementChild ? this.element.firstElementChild : undefined;
            return iframe && iframe.contentWindow || undefined;
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(SmoothlyFrame.prototype, "urlOrigin", {
        get: function () {
            var match = this.url.match(/^(([a-z]+\+)*[a-z]+:\/\/)?[^\/^\n]+/);
            return match ? match[0] : "*";
        },
        enumerable: false,
        configurable: true
    });
    SmoothlyFrame.prototype.componentDidLoad = function () {
        var _this = this;
        if (this.contentWindow)
            dist_6.listen(this.urlOrigin, function (destination, content) {
                if (destination == _this.name)
    ...
    SmoothlyFrame.prototype.send = function (message, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_g) {
    ...
    SmoothlyFrame.prototype.render = function () {
        return h("iframe", { src: this.url + "#" + window.location.origin, height: "100%", width: "100%" });
    };
    Object.defineProperty(SmoothlyFrame.prototype, "element", {
        get: function () { return getElement(this); },
        enumerable: false,
        configurable: true
    });
    return SmoothlyFrame;
}());
SmoothlyFrame.style = styleCss$2;
var styleCss$3 = ".sc-smoothly-icon-h{display:block;background:none !important}[hidden].sc-smoothly-icon-h{display:none}[size=small].sc-smoothly-icon-h{width:1.4em;height:1.4em}[size=medium].sc-smoothly-icon-h{width:1.8em;height:1.8em}[size=large].sc-smoothly-icon-h{width:2.8em;height:2.8em}[size=xlarge].sc-smoothly-icon-h{width:4em;height:4em}";
var SmoothlyIcon = /** @class */ (function () {
    function SmoothlyIcon(hostRef) {
        registerInstance(this, hostRef);
        this.fill = "solid";
        this.size = "medium";
    }
    SmoothlyIcon.prototype.loadDocument = function () {
        return __awaiter(this, void 0, void 0, function () {
            var url, response, _g, _h;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                        if (!this.name) return [3 /*break*/, 5];
                        url = "https://unpkg.com/ionicons@5.0.0/dist/svg/" + this.name + ".svg";
                    ...
                    case 2:
                        _h = (_j.sent()).replace(/(<title>)[\w\d\s\-]*(<\/title>)/, "<title>" + (this.toolTip || "") + "</title>");
                        return [3 /*break*/, 4];
                    case 3:
                        _h = undefined;
                        _j.label = 4;
    ...
    SmoothlyIcon.prototype.componentWillLoad = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_g) {
                switch (_g.label) {
    ...
    SmoothlyIcon.prototype.hostData = function () {
        return {
            innerHTML: this.document ? this.document.replace(" width=\"512\" height=\"512\"", "") : undefined,
        };
    };
    SmoothlyIcon.prototype.__stencil_render = function () {
        return [];
    };
    Object.defineProperty(SmoothlyIcon, "watchers", {
        get: function () {
            return {
                "name": ["loadDocument"]
            };
