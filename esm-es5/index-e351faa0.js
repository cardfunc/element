...
var ar = createCommonjsModule(function (module, exports) {
    ...
    function parse(country) {
        var result = Object.entries(names).find(function (entry) { return (entry[1] && entry[1].toLowerCase()) == country.toLowerCase(); });
...
var DateTime_1 = createCommonjsModule(function (module, exports) {
    ...
    (function (DateTime) {
        ...
        function localize(value, locale) {
            var localeString = locale ? locale : Intl.DateTimeFormat().resolvedOptions().locale;
            var localeOptions = {
...
var Encoding_1 = createCommonjsModule(function (module, exports) {
    ...
    (function (Encoding) {
        ...
        function is(value) {
            return typeof value == "string" && encoding.some(function (e) { return e == value; });
        }
        Encoding.is = is;
        function encode(value, encoding) {
            return Uint8Array.from(unescape(encodeURIComponent(value)).split(""), function (c) { return c.charCodeAt(0); });
        }
        Encoding.encode = encode;
        function decode(value, encoding) {
            return !value ? "" : decodeURIComponent(escape(Array.from(new Uint8Array(value.buffer, value.byteOffset, value.byteLength), function (c) { return String.fromCharCode(c); }).join("")));
        }
