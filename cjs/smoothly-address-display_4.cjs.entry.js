...
class AddressDisplay {
    ...
    render() {
        ...
        return index$2.dist_11.SE.is(value) || index$2.dist_11.FI.is(value) ?
            [
                index.h("address", null, value.street, index.h("br", null), value.zipCode, " ", value.city, index.h("br", null), index$1.dist_6.Name.from("en", value.countryCode)),
            ] :
            index.h("p", null, "Unknown address country: ", JSON.stringify(value));
    }
}
...
class AddressEdit {
    ...
    onSubmit(e) {
        e.stopPropagation();
        const result = Object.assign(Object.assign({}, e.detail), { countryCode: index$1.dist_6.Name.parse(e.detail.country), country: undefined });
        this.change.emit(result);
    }
    render() {
        return index$2.dist_11.SE.is(this.address) || index$2.dist_11.FI.is(this.address) ?
            [
                index.h("form", null, index.h("smoothly-input", { type: "text", name: "street", value: this.address.street }, "Street"), index.h("smoothly-input", { type: "postal-code", name: "zipCode", value: this.address.zipCode }, "Zip"), index.h("smoothly-input", { type: "text", name: "city", value: this.address.city }, "City"), index.h("smoothly-input", { type: "text", name: "country", value: index$1.dist_6.Name.from("en", this.address.countryCode) }, "Country"), index.h("div", null, index.h("smoothly-submit", { color: "primary", fill: "clear", prevent: true, onSubmit: (e) => this.onSubmit(e) }, "Save"), index.h("smoothly-trigger", { color: "primary", fill: "clear", name: "cancel" }, "Cancel"))),
            ] :
            index.h("p", null, "Unknown address country: ", JSON.stringify(this.address));
    }
}
AddressEdit.style = styleCss$1;

var State_1 = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(State_1);

var StateEditor_1 = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(StateEditor_1);

var Action_1 = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(Action_1);

var base = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(base);

var cardCsc = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(cardCsc);

var cardExpires = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(cardExpires);

var cardNumber = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(cardNumber);

var password = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(password);

var percent = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(percent);

var phonePrefix = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(phonePrefix);

var phone = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(phone);

var postalCode = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(postalCode);

var price = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class Handler {
    ...
    format(unformated) {
        ...
        const maxDecimals = !this.currency || index$1.dist.Currency.decimalDigits(this.currency) == undefined ? 2 : index$1.dist.Currency.decimalDigits(this.currency);
...
index$1.unwrapExports(price);

var text = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
index$1.unwrapExports(text);

var Handler = index$1.createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
class SmoothlyInput {
    constructor(hostRef) {
        ...
        this.disabled = false;
        this.smoothlyChanged = index.createEvent(this, "smoothlyChanged", 7);
    }
    get formatter() {
        let result;
        switch (this.type) {
...
exports.smoothly_address_display = AddressDisplay;
exports.smoothly_address_edit = AddressEdit;
